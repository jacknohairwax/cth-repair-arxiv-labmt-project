...
a single topic word swings the mean). The robustness table (section 8.4)
...
| `data/raw/Data_Set_S1.txt`                    | manually placed (see section 7.2; committed copy is shipped) |
...
set, e.g. an AI paper filed primarily under `cs.LG`; see section 9.6 for why
...
unlikely to be a sampling artefact at the 5% level — but see section 9 for why
