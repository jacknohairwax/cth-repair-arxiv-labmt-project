...
------------------------------
* No bootstrap. The previous group used bootstrap and could not explain
  what it was doing; we use straightforward standard errors of the mean
...
* No "stop band" trimming (e.g. dropping words with happiness in [4, 6]).
  The Dodds et al. paper uses one for time-series; we are doing
